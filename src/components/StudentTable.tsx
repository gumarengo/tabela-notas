      ...
      <tbody>
        {students.map((item) => (
          ...
          >
            ...
            <td className="p-3">
              {item.active && (
                <div className="px-2 py-1 inline-block rounded-md border border-green-800 bg-green-500 text-white">
                  Active
                </div>
              )}
              {!item.active && (
                <div className="px-2 py-1 inline-block rounded-md border border-red-800 bg-red-500 text-white">
                  Inactive
                </div>
              )}
            </td>
